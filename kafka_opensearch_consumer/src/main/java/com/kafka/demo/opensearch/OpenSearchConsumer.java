...
public class OpenSearchConsumer {
    ...
    public static RestHighLevelClient createOpenSearchClient() {
        String connString = "https://nl4cmzgh7i:ohgqs8lbui@kafka-cluster-4695356764.eu-central-1.bonsaisearch.net:443";
//        String connString = "https://c9p5mwld41:45zeygn9hy@kafka-course-2322630105.eu-west-1.bonsaisearch.net:443";
        ...
        if (userInfo == null) {
            ...
            restHighLevelClient = new RestHighLevelClient(RestClient.builder(new HttpHost(connUri.getHost(), connUri.getPort(), "https")));
            ...
            while (true) {
                ...
                for (ConsumerRecord<String, String> record : records) {
                    ...
                    try {
                        ...
                        log.error("something went wrong when sending records to opensearch");
                    }
                ...
                if (bulkRequest.numberOfActions() > 0) {
                    ...
                    log.info("offsets are committed");
